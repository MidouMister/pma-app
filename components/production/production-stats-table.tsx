              ...
              {filteredData.length === 0 ? (
                ...
                filteredData.map((row) => {
                  const isUnderperforming =
                    row.actualTaux > 0 &&
                    row.actualTaux < row.forecastTaux * 0.8
                  const varianceTaux = row.actualTaux - row.forecastTaux
                  const varianceText =
                    varianceTaux > 0 ? `+${varianceTaux}%` : `${varianceTaux}%`
                      ...
                      <TableCell className="min-w-0">
                        <div className="flex min-w-0 flex-col gap-2 py-1">
                          ...
                          <div className="flex min-w-0 items-center gap-2">
                            ...
                            <span
                              className="text-sm font-semibold wrap-break-word whitespace-normal text-foreground"
                          ...
                          <div className="ml-1.5 flex min-w-0 items-center gap-2 border-l-2 border-muted pl-2">
                            ...
                            <span
                              className="text-xs font-medium wrap-break-word whitespace-normal text-muted-foreground"
                              title={row.phaseName}
                            >
                              {row.phaseName}
                            </span>
