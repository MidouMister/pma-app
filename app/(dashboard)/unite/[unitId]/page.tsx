      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>
              Distribution des {totalProjects} projets par état
              d&apos;avancement
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          {projects.length > 0 && (
            <Button asChild variant="ghost" size="sm" className="gap-1">
              <Link href={`/unite/${unitId}/projects`}>Voir tous</Link>
            </Button>
          )}
        </CardHeader>
        <CardContent>
              ...
              {projects.map((project) => {
                ...
                return (
                  <Link
                    ...
                    className="group flex cursor-pointer flex-col gap-2 rounded-lg border p-4 transition-all duration-200 hover:-translate-y-0.5 hover:border-primary/30 hover:shadow-sm sm:flex-row sm:items-center sm:justify-between"
                  >
                    ...
                    <div className="flex items-center gap-4 sm:shrink-0">
                      <Badge
                        variant="secondary"
                        className={cn("text-xs font-medium", badgeStyle)}
                      >
                        {statusLabel}
                      </Badge>
      ...
      <Card className="overflow-hidden">
        <CardContent className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <p className="mt-1 max-w-sm text-sm text-muted-foreground">
            Les journaux d&apos;activité seront disponibles dans une prochaine
            mise à jour.
          </p>
        </CardContent>
      </Card>
